...
const countNumberOfChildren = (arr) => {
  // Solution code here...
  return arr.reduce( (a,b) => a + (b.children ? b.children.length : 0), 0)
};
...
const extractStat = (statName, arr) => {
  // Solution code here...
  return arr.reduce( (name, lax) => (statName === lax.stat.name ? name=lax : name=name ), null)
};
...
const extractChildren = (arr) => {
  ...
  newArr.reduce( (a, children) =>  children.children ? names.push(children.children) : null, 0)
  return names
};
